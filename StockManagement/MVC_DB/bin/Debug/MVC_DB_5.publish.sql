...
GO
/*
The column Description_Section on table [dbo].[Section] must be changed from NULL to NOT NULL. If the table contains data, the ALTER script may not work. To avoid this issue, you must add values to this column for all rows or mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
PRINT N'Altering [dbo].[Section]...';


GO
ALTER TABLE [dbo].[Section] ALTER COLUMN [Description_Section] NVARCHAR (50) NOT NULL;
